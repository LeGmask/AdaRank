...
(time make run ARGS="-R benchmark networks/sujet.net") >> benchmark.md 2>> benchmark.md
echo -e "\`\`\`" >> benchmark.md
echo -e "- **Creux**" >> benchmark.md
echo -e "\`\`\`sh" >> benchmark.md
(time make run ARGS="-R benchmark -C networks/sujet.net") >> benchmark.md 2>> benchmark.md
echo -e "\`\`\`" >> benchmark.md

echo -e "## worm.net benchmark" >> benchmark.md
echo -e "- **Plein**" >> benchmark.md
echo -e "\`\`\`sh" >> benchmark.md
(time make run ARGS="-R benchmark networks/worm.net") >> benchmark.md 2>> benchmark.md
echo -e "\`\`\`" >> benchmark.md
echo -e "- **Creux**" >> benchmark.md
echo -e "\`\`\`sh" >> benchmark.md
(time make run ARGS="-R benchmark -C networks/worm.net") >> benchmark.md 2>> benchmark.md
echo -e "\`\`\`" >> benchmark.md

echo -e "## brainlinks.net benchmark" >> benchmark.md
echo -e "- **Creux**" >> benchmark.md
echo -e "\`\`\`sh" >> benchmark.md
(time make run ARGS="-R benchmark -C networks/brainlinks.net") >> benchmark.md 2>> benchmark.md
echo -e "\`\`\`" >> benchmark.md

echo -e "## linux26.net benchmark" >> benchmark.md
echo -e "- **Creux**" >> benchmark.md
echo -e "\`\`\`sh" >> benchmark.md
(time make run ARGS="-R benchmark -C networks/linux26.net") >> benchmark.md 2>> benchmark.md
echo -e "\`\`\`" >> benchmark.md